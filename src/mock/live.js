    ...
    if (params["id"] == 0) {
      list = Mock.mock({
        data: {
          ...
          video:
            "https://hwvod.mogucdn.com/vodcq1251964405/5285890800198363387/f0.mp4",
          isFocus: "@boolean",
        },
      });
    } else if (params["id"] == 1) {
      list = Mock.mock({
        data: {
          ...
          video:
            "https://hwvod.mogucdn.com/vodcq1251964405/5285890804913924517/f0.mp4",
          isFocus: "@boolean",
        },
      });
    } else {
      list = Mock.mock({
        data: {
          ...
          video:
            "https://hwvod.mogucdn.com/vodcq1251964405/5285890810420970201/f0.mp4",
          isFocus: "@boolean",
        },
      });
    }
